package api.test_notifii_demo.api_module.apitestclasses;
...
import api.test_notifii_demo.api_module.apipageclasses.API_PUTDataset;
import api.test_notifii_demo.api_module.apipageclasses.API_GETDataset;
import api.test_notifii_demo.api_module.apipageclasses.API_POSTDataset;
public class TC_CRUD_API extends BaseClass {
	...
	public void doRequest() throws Exception { 
		...
		String primaryInfo = API_POSTDataset.primaryInfo;
		Constants.PRIMARY_INFO = primaryInfo;
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath ,API_POSTDataset.projectName);
		int datasetLength = API_POSTDataset.datasetLength; 
